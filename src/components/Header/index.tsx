  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        ...
        >
          {/* <!-- header top left --> */}
          <div className="xl:w-auto flex-col sm:flex-row  w-full flex sm:justify-between sm:items-center gap-5 sm:gap-20">
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            {/* <!-- divider --> */}
            <span className="hidden xl:block w-px h-7.5 bg-white"></span>
        ...
        {/* <!-- header top end --> */}
        <div className="px-45 hidden lg:flex gap-2.5">
          <a
            className="relative text-white/70 hover:text-white text-[13px] font-thin tracking-widest  px-3.5 py-1.5 rounded-md hover:bg-white/[0.07] transition-all
            after:content-[''] after:absolute after:bottom-0.5 after:left-3.5 after:right-3.5 after:h-0.5 after:bg-orange after:rounded-sm after:scale-x-0 after:origin-left after:transition-transform hover:after:scale-x-100"
          >
            Monitor
          </a>
          <a
