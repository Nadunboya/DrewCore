...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-gradient-to-br from-black via-dark to-black py-2 px-3">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        {/* <!-- footer menu start --> */}
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-[1.5fr_1fr_1fr] gap-10 pt-17.5 xl:pt-22.5 pb-10 xl:pb-5">
          {" "}
          <div className="w-full">
            <h2 className="mb-7.5 text-custom-1 font-medium text-orange">
              Help & Support
            </h2>
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                drewcore,No 47, Kandy Road, Ragama
              </li>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className="flex ease-out duration-200 hover:text-white"
              >
                <svg
            ...
            {/* <!-- Social Links end --> */}
            <div className="text-body text-custom-xs py-10">
              &copy;2026. All rights reserved by{" "}
              <span className="text-yellow-dark-2 font-medium">TechYoba</span>
            </div>
          </div>
